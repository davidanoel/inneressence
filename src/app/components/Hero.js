    ...
    >
      ...
      <div className="relative z-10 container-custom text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          {/* Minimal Trust Badge */}
          <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-md px-6 py-3 rounded-full shadow-lg border border-white/50">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-light text-white leading-tight tracking-wide drop-shadow-lg">
              ...
              <span className="block font-normal bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                Inner Essence
              </span>
            </h1>
          ...
          <div className="pt-8">
            <a
              href="#contact"
              className="inline-flex items-center bg-white/95 hover:bg-white text-gray-900 font-medium px-10 py-5 rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-white/50 backdrop-blur-sm border border-white/30"
            >
              Begin Your Journey
          ...
          <div className="pt-12">
            <div className="inline-flex items-center space-x-8 bg-white/10 backdrop-blur-md px-8 py-4 rounded-full border border-white/20">
